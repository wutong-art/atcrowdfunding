...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        var properties = {
            ...
            callback:pageSelectCallback,                        // 页码跳转
            items_per_page:${requestScope.pageInfo.pageSize},   // 每页显示条数
            current_page:${requestScope.pageInfo.pageNum-1},    // 当前页 Pagination内部使用pageIndex来管理页码，pageIndex从0开始，pageNum从1开始
    ...
    // 回调函数的含义：声明出来后不是自己调用，而是交给系统或框架调用
    // 用户点击“上一页、下一页、1、2、3......”这样的页码时调用这个函数实现页码跳转
    // pageIndex是Pagination传给我们的那个“从0开始的”页码
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <%--旧的代码<button type="button" class="btn btn-primary" style="float:right;"
